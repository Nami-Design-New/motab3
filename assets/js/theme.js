...
window.addEventListener("load", () => {}), $(function () {
    ...
    $(".menu-toggle").on("click", function () {
        ...
        var e = $("#font_url").val(), t = $("#font_family").val(), c = $("head");
    ...
    $(".choose-skin li").on("click", function () {
        ...
        $(".choose-skin li").removeClass("active"), t.addClass("active"), e.attr("data-nami", "theme-" + t.data("theme"))
        ...
        t.style.setProperty("--sidebar-img", "url(https://www.wrraptheme.com/templates/nami/assets/img/sidebar-bg/sidebar-" + e[1] + ".jpg)"), $(".sidebar-img-active").removeClass("sidebar-img-active"), $(".sidebar-img-" + e[1]).addClass("sidebar-img-active")
...
//     })
    ...
    $(".password-meter .form-control").on("input", function () {
        var e = 0, t = $(this).val(), c = new RegExp("[A-Z]"), o = new RegExp("[a-z]"), n = new RegExp("[0-9]"),
            r = new RegExp("^(?=.*?[#?!@$%^&*-]).{1,}$");
